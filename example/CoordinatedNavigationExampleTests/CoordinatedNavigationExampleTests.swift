...
final class CoordinatedNavigationExampleTests: XCTestCase {
    ...
    func testDeallocation() async {
        ...
        var rootCoordinator: RootStackCoordinator? = RootStackCoordinator(sequence: sequenceCoordinator!)
        weak var weakRootCoordinator: RootStackCoordinator? = rootCoordinator
